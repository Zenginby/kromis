...
| `app.py` | 1811 | 6 | `assets_store`, `azure_client`, `backup`, `catalog`, `chat_client`, `chat_prompt`, `chat_providers`, `chat_store`, `color_names`, `composite`, `credstore`, `errlog`, `folders`, `guncelleme`, `models`, `palette`, `palette_store`, `paths`, `prefs`, `providers`, `storage`, `version` | 3 | 28 |
...
| `models.py` | 794 | 2 | `azure_client`, `catalog`, `palette` | 3 | 12 |
...
| `paths.py` | 167 | 0 | — | 6 | 3 |
| `prefs.py` | 212 | 3 | `catalog`, `jsonstore`, `models` | 1 | 3 |
