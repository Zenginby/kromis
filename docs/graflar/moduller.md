...
| `models.py` | 1023 | 3 | `azure_client`, `catalog`, `palette` | 3 | 13 |
...
| `paths.py` | 289 | 1 | `errlog` | 6 | 3 |
| `prefs.py` | 222 | 4 | `catalog`, `jsonstore`, `models` | 1 | 4 |
