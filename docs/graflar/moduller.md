...
flowchart TD
  ...
  subgraph katman10["katman 10"]
    ...
    n_services_sablon["services.sablon<br/>78 satır"]
  end
  ...
  subgraph katman6["katman 6"]
    ...
    n_services_hesap["services.hesap<br/>360 satır"]
  ...
  n_routers_hesap --> n_services_hukuk
  ...
  n_routers_hesap --> n_services_odeme
  ...
  n_routers_kok --> n_services_hukuk
  ...
  n_routers_odeme --> n_services_hukuk
  ...
  n_services_odeme --> n_services_hukuk
...
| `routers/hesap.py` | 474 | 13 | `errlog`, `i18n`, `models`, `services.ayar`, `services.cerez`, `services.db`, `services.defter`, `services.depo_kimlik_bilgisi`, `services.dil`, `services.disa_aktar`, `services.gunluk`, `services.hesap`, `services.hukuk`, `services.isci`, `services.kimlik`, `services.kiraci`, `services.koken`, `services.kuyruk`, `services.odeme`, `services.planlar`, `services.polar`, `services.posta`, `services.sablon`, `services.tablolar`, `services.zaman` | 1 | 3 |
...
| `routers/kok.py` | 110 | 11 | `i18n`, `services.ayar`, `services.dil`, `services.hukuk`, `services.kimlik`, `services.sablon`, `services.tablolar` | 1 | 0 |
| `routers/odeme.py` | 215 | 12 | `services.db`, `services.defter`, `services.gunluk`, `services.hukuk`, `services.kimlik`, `services.kiraci`, `services.koken`, `services.odeme`, `services.planlar`, `services.polar`, `services.tablolar`, `services.zaman` | 1 | 1 |
...
| `services/dil.py` | 194 | 3 | `i18n`, `services.cerez` | 18 | 5 |
