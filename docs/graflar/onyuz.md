...
flowchart LR
  ...
  n_chat_js["chat.js"] -->|11| n_core_js["core.js"]
...
| `static/chat.js` | 2037 | 81 | `/api/arena/{}`, `/api/arena/{}/winner`, `/api/chat`, `/api/chats`, `/api/chats/{}`, `/api/prefs`, `/output/{}.png` |
| `static/core.js` | 2302 | 74 | `/api/edit`, `/api/generate`, `/api/image/{}`, `/api/output/{}/download`, `/api/prefs`, `/output/`, `/output/{}` |
| `static/folders.js` | 1698 | 56 | `/api/folders`, `/api/folders/{}`, `/api/folders/{}/download`, `/api/history`, `/api/images`, `/api/import`, `/output/{}` |
