...
| --- | --- | --- | --- |
| `static/admin.js` | 415 | 0 | `/api/admin/isler`, `/api/admin/isler/{}/iptal`, `/api/admin/kullanicilar`, `/api/admin/kullanicilar/{}/oturum-dusur`, `/api/admin/kullanicilar/{}/tavan`, `/api/admin/metrikler` |
...
| `static/i18n.js` | 84 | 2 | — |
| `static/isler.js` | 565 | 1 | `/api/hesap/ben`, `/api/history`, `/api/isler`, `/api/isler/akis`, `/api/isler/{}/iptal`, `/api/isler/{}/yeniden`, `/api/kota`, `/output/{}${videoMu ` |
