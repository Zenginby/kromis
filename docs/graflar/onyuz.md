...
| `static/chat.js` | 2656 | 90 | `/api/arena/{}`, `/api/arena/{}/winner`, `/api/chat`, `/api/chats`, `/api/chats/{}`, `/api/prefs`, `/output/{}.${videoMu ` |
...
| `static/settings.js` | 459 | 11 | `/api/prefs`, `/api/settings` |
