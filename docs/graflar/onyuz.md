...
| --- | --- | --- | --- |
| `static/admin.js` | 553 | 0 | `/api/admin/isler`, `/api/admin/isler/{}/iptal`, `/api/admin/kullanicilar`, `/api/admin/kullanicilar/{}/kredi`, `/api/admin/kullanicilar/{}/oturum-dusur`, `/api/admin/kullanicilar/{}/plan`, `/api/admin/kullanicilar/{}/tavan`, `/api/admin/metrikler`, `/api/admin/odeme-olaylari` |
...
| `static/core.js` | 3392 | 95 | `/api/edit`, `/api/generate`, `/api/image/{}`, `/api/kredi`, `/api/output/{}/download`, `/api/prefs`, `/api/video`, `/api/video/animate`, `/output/`, `/output/{}`, `/output/{}.png` |
...
| `static/settings.js` | 1221 | 31 | `/api/guncelleme`, `/api/hesap/ben`, `/api/hesap/cikis`, `/api/prefs`, `/api/settings` |
