...
def test_output_directory_name_returns_404(tmp_path, dizinler):
...
def test_output_missing_file_returns_404(tmp_path, dizinler):
    c = _client(tmp_path, dizinler)
...
def test_the_download_endpoint_reuses_the_single_traversal_guard(tmp_path, monkeypatch, dizinler):
