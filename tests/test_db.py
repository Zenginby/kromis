...
BAS = "0008_odeme"
ZINCIR = ["0008_odeme", "0007_kredi", "0006_rls", "0005_kota", "0004_isler", "0003_arena_win", "0002_deneme_turu",
...
def test_the_alembic_config_loads_and_names_the_revision_chain():
    """`alembic.ini` + `alembic/` okunuyor; hat tek kollu: `0000_zemin` → … → `0006_rls` → `0007_kredi` → `0008_odeme`."""
